...
async function loadProfile() {
    try {
        const response = await axios.get('http://localhost:8080/members/memberInfo', { withCredentials: true });
...
function editProfile() {
    if (confirm("프로필 사진을 수정하시겠습니까?")) {
        ...
        if (imageInput.files && imageInput.files[0]) {
            ...
            axios.post('http://localhost:8080/members/changeProfile', formData, {
